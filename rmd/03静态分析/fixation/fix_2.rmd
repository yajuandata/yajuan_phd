...
fixation_ss <- function(dt_path, loss_info, dt_mianji1, dt_mianji2) {
  ...
  dt_fixation_summary <- bind_rows(dt_fixation_summary_a, dt_fixation_summary_b) %>%
    select(participants, type, pic, AOI_type, AOI, fixation_duration, fixation_ps, fixation_count, fixation_per_mianji, fixation_ps_cr_r, fixation_ps_cr_p)
...
# 定义处理结果的保存路径
save_path <- "../yajuan_data/statics/fixation/fixation_02.csv"
