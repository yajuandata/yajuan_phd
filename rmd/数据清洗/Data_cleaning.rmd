...
track_loss_rate_bin <- function(dt) {
    ...
    track_loss_rate_t <- track_loss_rate_p %>% left_join(track_loss_rate_b, by = "block") %>% mutate(track_loss_rate_total = mean(dt2$track_loss), participant = dt2$participant[1])
